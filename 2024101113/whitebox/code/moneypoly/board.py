"""Module defining the MoneyPoly game board layout and tile types."""
from moneypoly.property import create_property, PropertyGroup
...
class Board:
    ...
    def _create_properties(self):
        ...
        g = self.groups
        return [
            create_property("Mediterranean Avenue",   1,  60,  2,  g["brown"]),
            create_property("Baltic Avenue",          3,  60,  4,  g["brown"]),
            create_property("Oriental Avenue",        6,  100, 6,  g["light_blue"]),
            create_property("Vermont Avenue",         8,  100, 6,  g["light_blue"]),
            create_property("Connecticut Avenue",     9,  120, 8,  g["light_blue"]),
            create_property("St. Charles Place",      11, 140, 10, g["pink"]),
            create_property("States Avenue",          13, 140, 10, g["pink"]),
            create_property("Virginia Avenue",        14, 160, 12, g["pink"]),
            create_property("St. James Place",        16, 180, 14, g["orange"]),
            create_property("Tennessee Avenue",       18, 180, 14, g["orange"]),
            create_property("New York Avenue",        19, 200, 16, g["orange"]),
            create_property("Kentucky Avenue",        21, 220, 18, g["red"]),
            create_property("Indiana Avenue",         23, 220, 18, g["red"]),
            create_property("Illinois Avenue",        24, 240, 20, g["red"]),
            create_property("Atlantic Avenue",        26, 260, 22, g["yellow"]),
            create_property("Ventnor Avenue",         27, 260, 22, g["yellow"]),
            create_property("Marvin Gardens",         29, 280, 24, g["yellow"]),
            create_property("Pacific Avenue",         31, 300, 26, g["green"]),
            create_property("North Carolina Avenue",  32, 300, 26, g["green"]),
            create_property("Pennsylvania Avenue",    34, 320, 28, g["green"]),
            create_property("Park Place",             37, 350, 35, g["dark_blue"]),
            create_property("Boardwalk",              39, 400, 50, g["dark_blue"]),
        ]
